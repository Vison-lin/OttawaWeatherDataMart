...
from FactTableStagingP6 import data_staging_phase_six
...
data_staging_phase_five("Staging_4_Integrity_Checked", "Accident_table")

data_staging_phase_six("Staging_4_Integrity_Checked", "Staging_6_Main")